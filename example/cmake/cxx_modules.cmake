...
set(SCAN_COMMAND ${CMAKE_CURRENT_LIST_DIR}/scan.pl)
set(COMPILE_COMMAND ${CMAKE_CURRENT_LIST_DIR}/compile.pl ${CMAKE_CURRENT_BINARY_DIR}/__headers__/)
...
function(cxx_module_sources target)
  ...
  foreach(arg IN LISTS ARGN)
    ...
    add_custom_command(OUTPUT ${module_map_path} COMMAND ${SCAN_COMMAND} ${filename} ${CMAKE_CURRENT_BINARY_DIR} ">>" ${module_map_path} DEPENDS ${filename} APPEND)
  endforeach()
endfunction()
...
function(cxx_module_compile_options target)
  ...
  set(compile_command ${COMPILE_COMMAND} ${module_map_path})
  set_target_properties(${target} PROPERTIES CXX_COMPILER_LAUNCHER "${compile_command}")
endfunction()
